...
select maxYear.*, minYear.year, minYear.average_goods_price, ROUND((POWER((maxYear.average_goods_price /minYear.average_goods_price),(1/13))-1)*100,2) as percentage_increase  from maxYear
join minYear
